...
Inicio</Link>
       <Link onClick={handleMenu} className='hover:text-black hover:font-semibold font-bold flex gap-3' href="/aromaterapia"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
